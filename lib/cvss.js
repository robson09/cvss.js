...
function CVSS(vector) {
  ...
  function getVersion() {
    const vectorObject = getVectorObject();
    let version = vectorObject.CVSS;
    if (version === "3.0") { version = "3.0"; }
    else if (version === "3.1") { version = "3.1"; }
    else if (version === undefined) { version = "3.0"; }
    else {
      version = "3.0";
    }
    return version;
  ...
  return { vector, getScore, getRating, getVectorObject, getTemporalScore, getVersion };
}
